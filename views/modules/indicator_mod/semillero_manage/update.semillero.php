    ...
    <div class="col-lg-10 offset-lg-1">
        <form action="index.php?c=semillero&a=updateData" method="post" id="">
            ...
            <div class="form-signIn">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <select name="data[7]" class="form-control form-input">
                                <option value="<?php echo $Semillero["seml_nivelFormacion"];?>" selected>Elige una opción</option>
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="data[9]" class="form-control form-input" value="<?php echo $Semillero["semI_fechaIni"];?>">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            <label for="" class="form-label">Fecha fin</label>
                            <input type="text" name="data[10]" class="form-control form-input" value="<?php echo $Semillero["semI_fechaFin"];?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="data[11]" class="form-control form-input" value="<?php echo $Semillero["semI_proyectos"];?>">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            <label for="" class="form-label">Horas semanales</label>
                            <input type="text" name="data[12]" class="form-control form-input" value="<?php echo $Semillero["semI_horasSemanales"];?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="data[13]" class="form-control form-input" value="<?php echo $Semillero["semI_productos"];?>">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            <label for="" class="form-label">Año</label>
                            <select name="data[14]" class="form-control form-input">
                ...
                <input type="hidden" name="data[15]" value="<?php echo $Semillero["semI_code"];?>">
                <div class="row">
                    <div class="col">
