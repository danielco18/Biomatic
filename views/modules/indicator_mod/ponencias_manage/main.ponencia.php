                                ...
                                <table id="dataTable" class="table dataTable table-responsive no-footer">
                                    ...
                                    ?>
                                        ...
                                        <td><?php echo $row["pon_tipoPonencia"]; ?></td>
                                            <td>
                                                <a href="index.php?c=ponencias&a=update&token=<?php echo $row['pon_code'];?>" class="icon-table">
                                                    <i class="material-icons icon-yellow">create</i>
                                                </a>
                                                <a href="index.php?c=ponencias&a=delete&token=<?php echo $row['pon_code'];?>" class="icon-table" onclick="return confirm('Está seguro?');">
